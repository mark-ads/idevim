  ...
  config = function()
    ...
    require("bufferline").setup({
      options = {
        ...
        offsets = {
          {
            filetype = "neo-tree", -- тип панели, под которую делаем отступ
            text = "Neo-tree", -- текст заголовка панели
            highlight = "Directory", -- highlight для текста
            text_align = "center", -- выравнивание текста
            separator = true, -- ставить разделитель между буферлайном и деревом
          },
        },
      },
      highlights = {
